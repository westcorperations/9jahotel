              ...
              <div class="single-content-wrap padding-top-60px">
                <div id="description" class="page-scroll">
                  ...
                  >
                    ...
                    <ul class="list-items">
                      <li>
                        <i class="la la-dot-circle mr-2"></i>No smoking, parties
                        or events.
                      </li>
                      <li>
                        <i class="la la-dot-circle mr-2"></i>Check-in time is 2
                ...
                <div class="copy-to-clipboard">
                  <div class="contact-form-action d-flex align-items-center">
                    ...
                    <input
                      ...
                      value="https://www.tripstar.com/share/101WxMB0oac1hVQQ==/"
                    />
                    <div class="btn-box">
