                ...
                >
                  ...
                  <div class="filter-option mr-5">
                    <h3 class="title font-size-16">
                      <i class="la la-clock-o mr-1"></i>Date:
                      <span class="text-color ml-2"
                  ...
                  <div class="filter-option mr-5">
                    <h3 class="title font-size-16">
                      <i class="la la-user mr-1"></i>Adults:
                      <span class="text-color ml-2">1</span>
                    </h3>
                  </div>
                  <div class="filter-option mr-5">
                    <h3 class="title font-size-16">
                      <i class="la la-user mr-1"></i>Children:
                      <span class="text-color ml-2">1</span>
                    </h3>
                  </div>
                </div>
                      ...
                      <div class="input-box">
                        ...
                        <div class="form-group">
                          <div class="dropdown dropdown-contain">
                            <a
                              class="dropdown-toggle form-control dropdown-btn pl-3"
                              href="#"
